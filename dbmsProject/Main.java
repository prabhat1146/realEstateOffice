        ...
        if(e.getSource()==update)
        {
            ...
            if(combo.getSelectedIndex()==1)
            {
                ...
                if (isTrue)
                {
                    ...
                    q="insert into rented values("+aid+" ,"+pid+")";
                    isUpdate=addIntoTable(q);
                    if(isUpdate)
                    {
                        update.setBackground(Color.GREEN);
...
class LoginAdmin extends UserHomePage
{
    ...
    LoginAdmin()
    {
        ...
        try
        {
            BufferedImage image= ImageIO.read(new File("E:\\StudyFiles\\Project\\realEstateOffice\\admin.jpg"));
...
class LoginAgent extends UserHomePage
{
    ...
    LoginAgent()
    {
       ...
       // lImage.setBounds(100,50,500,400);
        ...
        try
        {
            BufferedImage image= ImageIO.read(new File("E:\\StudyFiles\\Project\\realEstateOffice\\img5.jpg"));
            ImageIcon imageIcon=new ImageIcon(image);
            Image getImage=imageIcon.getImage();
            Image scaleImage=getImage.getScaledInstance(lImage.getWidth(),lImage.getHeight(),Image.SCALE_SMOOTH);
            ImageIcon scaleIcon=new ImageIcon(scaleImage);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==b9)
        {
            ...
            SoldOrRentProperty s=new SoldOrRentProperty(aid);
...
class LoginOffice extends UserHomePage
{
    ...
    LoginOffice()
    {
        ...
        try
        {
            BufferedImage image= ImageIO.read(new File("E:\\StudyFiles\\Project\\realEstateOffice\\agent'sOffice.jpg"));
            ImageIcon imageIcon=new ImageIcon(image);
            Image getImage=imageIcon.getImage();
            Image scaleImage=getImage.getScaledInstance(lImage.getWidth(),lImage.getHeight(),Image.SCALE_SMOOTH);
            ImageIcon scaleIcon=new ImageIcon(scaleImage);
               ...
               try {
                   ...
                   if(isLogin)
                   {
                       if(userId.getText().equals(String.valueOf(UserId)))
                       {
                           ...
                           if(isPasswordCorrect(Password))
                           {
                               LoginAgent l=new LoginAgent(id);
...
class HomePage implements  ActionListener {
    ...
    HomePage()
    {
        ...
        try
        {
            BufferedImage image= ImageIO.read(new File("E:\\StudyFiles\\Project\\realEstateOffice\\homeImg.jpg"));
            ImageIcon imageIcon=new ImageIcon(image);
            Image getImage=imageIcon.getImage();
            Image scaleImage=getImage.getScaledInstance(lImage.getWidth(),lImage.getHeight(),Image.SCALE_SMOOTH);
            ImageIcon scaleIcon=new ImageIcon(scaleImage);
